...
class Flurorouter {
  ...
  static String registerRoute3 = '/auth/registergestor/:tokenUser';
  ...
  static void configureRoutes() {
    ...
    router.define(registerRoute3,
        handler: AdminHandlers.register3, transitionType: TransitionType.none);
